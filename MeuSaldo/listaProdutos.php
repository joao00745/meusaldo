...
$lucroProdutos = $receitaTotal - $despesaTotal;
?>
                                ...
                                if (mysqli_num_rows($resultado) > 0) {
                                    ...
                                    while ($produto = mysqli_fetch_assoc($resultado)) {
                                        ...
                                        echo "<td>R$ " .
                                            ...
                                            echo "<td>
                                                <a href='removerProduto.php?id=" . $produto['idAnuncio'] . "'
