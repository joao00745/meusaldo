...
<html lang="pt-bt">
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="formUsuario.php">Register</a>
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <a href="formAnuncio.php" class="btn btn-primary">
                <i class="fas fa-plus"></i>
                Criar novo produto
            </a>

            <a href="listaProdutos.php" class="btn btn-secondary">
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($resultadoProdutos) > 0) {
                            ...
                            while ($produto = mysqli_fetch_assoc($resultadoProdutos)) {
                                ...
                                echo "<td>";
                                echo htmlspecialchars($produto['idAnuncio']);
                                echo "</td>";

                                echo "<td>";
                                echo htmlspecialchars($produto['nomeProduto']);
                                echo "</td>";

                                echo "<td>";
                                echo htmlspecialchars($produto['estoqueProduto']);
                                echo "</td>";

                                echo "<td>";
                                echo htmlspecialchars($produto['categoriaAnuncio']);
                                echo "</td>";
