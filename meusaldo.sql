...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16-Set-2026 às 22:29
...
(52, 'gabriel', 'gabriel@gmail.com', '12345', '12345');
...
CREATE TABLE `vendas` (
  ...
  `lucroVenda` decimal(10,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
ALTER TABLE `anuncios`
  MODIFY `idAnuncio` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de tabela `movimentacoes`
--
ALTER TABLE `movimentacoes`
  MODIFY `idMovimentacao` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `vendas`
  MODIFY `idVenda` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
